namespace SpriteKind {
    export const Minerals = SpriteKind.create()
    export const BEGINmineral = SpriteKind.create()
    export const rightcornermineral = SpriteKind.create()
    export const uprightmineral = SpriteKind.create()
}
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestClosed, function (sprite, location) {
    game.showLongText("You found the hidden chest! Congratulations!", DialogLayout.Bottom)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile10`, function (sprite, location) {
    controller.moveSprite(Player_Miner, 25, 25)
    Player_Miner.say("There's a crack!", 500)
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile11`, function (sprite, location) {
    Player_Miner.say("There's a crack!", 500)
})
let mineral4: Sprite = null
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
Player_Miner = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f f 2 2 f f f . . . . 
    . . . f f f 2 2 2 2 f f f . . . 
